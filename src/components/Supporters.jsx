        ...
        <div className="h-full w-full flex flex-col items-center justify-center">
          <div className="upside flex justify-between items-center pl-0 space-x-6 sm:space-x-0 sm:pl-10 w-[80%] ">
            <a href="https://www.orangedao.xyz/" target="_blank">
              <img src="Icons/Supporters/Suptho-OrangeDAO 1.svg" className="w-48 sm:w-48" alt="" />
            </a>
            <a href="https://www.floriventures.com/" target="_blank">
              <img src="Icons/Supporters/flori-ventures 1.svg" className="w-28 pl-0 sm:w-40 sm:pl-14" alt="" />
            </a>
            <a href="https://allegory.earth/" target="_blank">
              <img src="Icons/Supporters/Group 14.svg" className="w-60 sm:w-80" alt="" />
            </a>
          </div>
