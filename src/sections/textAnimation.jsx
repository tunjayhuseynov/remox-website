...
function TextAnimation() {
    return <div className="font-semibold  text-white min-h-[100px]  sm:min-h-[300px] 2xl:min-h-[500px] bg-main relative z-[99] py-4 flex flex-col items-center w-full justify-center space-y-10 px-12 xl:px-32">
        <div className="min-h-[150px] sm:min-h-[390px] w-full   py-4 flex flex-col items-center justify-center gap-16 sm:gap-20 px-12 lg:px-16 2xl:px-0">
                ...
                <div className="w-full h-full flex flex-col gap-16 sm:gap-auto sm:flex-row justify-between items-center ">
                    <div className="flex items-center justify-start gap-2 border  py-3 px-5 min-w-[29rem] border-primary rounded-lg hover:bg-sec transition-all hover:transition-all">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-[#aaaaaa] text-xl font-semibold">Celo Foundation</div>
                        </div>
                    </div>
                    <div className="flex items-center justify-start gap-2 border  py-3 px-5 min-w-[29rem] border-primary rounded-lg hover:bg-sec transition-all hover:transition-all">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="text-[#aaaaaa] text-xl font-semibold">Valora & Celo Foundation</div>
                        </div>
                    </div>
                </div>
            </div>
