...
function TextAnimation() {
    return <div className="font-semibold  text-white min-h-[100px]  sm:min-h-[300px] 2xl:min-h-[500px] bg-main relative z-[99] py-4 flex flex-col items-center w-full justify-center space-y-10 px-8 xl:px-16 2xl:max-w-[1650px] mx-auto">
        <div className="min-h-[150px] sm:min-h-[390px] w-full   py-4 flex flex-col items-center justify-center gap-16 sm:gap-20 px-12 lg:px-32 2xl:px-28">
            ...
            <div className="flex flex-col gap-16 w-full h-full items-center justify-center">
                ...
                <div className="w-full h-full flex flex-col sm:flex-row items-center  sm:py-0 gap-8 sm:gap-0 justify-center sm:justify-between ">
        ...
        <div className="text-2xl sm:text-4xl font-bold flex items-center justify-center !mt-0 gap-4 md:text-4xl xl:text-[50px] 2xl:text-[50px] min-h-[225px] sm:min-h-[450px]">One platform for <TypeAnimation
