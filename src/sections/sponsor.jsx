...
export default function Sponsor() {
    ...
    return <div className="w-full py-5 bg-main relative z-[99]">
        <div className="min-h-[175px] sm:min-h-[450px] w-full flex flex-col items-center justify-between pb-8 gap-16 sm:gap-12 px-12 lg:px-20 2xl:px-28 2xl:max-w-[1650px] mx-auto">
